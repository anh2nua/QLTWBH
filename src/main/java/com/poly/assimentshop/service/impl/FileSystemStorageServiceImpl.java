package com.poly.assimentshop.service.impl;
...
import com.poly.assimentshop.exception.StorageException;
import com.poly.assimentshop.exception.StorageFileNotFoundException;
...
public Resource loadAsResource(String filename) {
	try {
		...
		throw new StorageFileNotFoundException("Not read:" + filename);
	} catch (Exception e) {
		throw new StorageFileNotFoundException("Not read:" + filename);
	}
}
...
public void init() {
	try {
		...
		throw new StorageException("Not", e);
	}
}
}
